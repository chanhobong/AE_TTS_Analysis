...
- Train Flow Matching model on Normal latent space
- Extract spatial latents from trained AE encoder
- Train LatentVelocityEstimator using Conditional Flow Matching
"""
...
from models import LatentVelocityEstimator, compute_flow_matching_loss
...
def train_one_epoch(model: nn.Module, loader: DataLoader, optimizer: torch.optim.Optimizer,
    ...
    for batch in loader:
        ...
        loss, _ = compute_flow_matching_loss(model, z_0, device)
...
def build_argparser():
    p = argparse.ArgumentParser(description="Train Flow Matching model on Normal latent space")
    ...
    p.add_argument("--seed", type=int, default=42,
                   help="Random seed")
    p.add_argument("--out_dir", type=str, default="./outputs/flow_matching",
...
def main():
    ...
    with torch.no_grad():
        ...
        # Expected: (1, base*8, Z/8, Y/8, X/8)
        # For base=16: (1, 128, 8, 16, 16)
