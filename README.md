...
![ROC Curve](https://github.com/사용자아이디/레포지토리이름/blob/main/roc_curves_comparison.png?raw=true)
...
![Boxplot](https://github.com/사용자아이디/레포지토리이름/blob/main/myocardium_boxplot.png?raw=true)
